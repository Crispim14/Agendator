...
const EditScheduleScreen = ({ route, navigation }) => {
    ...
    const [servicePickers, setServicePickers] = useState(schedule.services || [{ serviceId: '', providerId: '' }]);
    ...
    return (
        <ScrollView style={{ flex: 1, padding: 16, backgroundColor: '#1A2833' }}>
            ...
            <Button title="Salvar Alterações" onPress={saveSchedule} />
        </ScrollView>
    );
};
